...
public class Practice12PathEffectView extends View {
...

    {
        ...
        dashPath.close();
        effect4 = new PathDashPathEffect(dashPath, 40, 0, PathDashPathEffect.Style.MORPH);
    }
